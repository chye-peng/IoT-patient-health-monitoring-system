        ...
        <?php 
            $this->registerJs("
                ...
                document.getElementById('toggleCurrentPassword').addEventListener('click', function () {
                    var passwordInput = document.getElementById('medstaffprofileform-password_current'); // medstaffprofileform-password is the combination of small case of model name and form field name
                ...
                document.getElementById('togglePassword').addEventListener('click', function () {
                    var passwordInput = document.getElementById('medstaffprofileform-password'); 
                    if (passwordInput.type === 'password') {
                        passwordInput.type = 'text';
                        this.classList.remove('fa-eye-slash');
                        this.classList.add('fa-eye');
                ...
                document.getElementById('toggleConfirmPassword').addEventListener('click', function () {
                    var passwordInput = document.getElementById('medstaffprofileform-password_confirm'); 
                    if (passwordInput.type === 'password') {
                        passwordInput.type = 'text';
                        this.classList.remove('fa-eye-slash');
                        this.classList.add('fa-eye');
